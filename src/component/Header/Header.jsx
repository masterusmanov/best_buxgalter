...
export default function Header() {
  return (
    <div className="container mx-auto px-2 lg:px-0 xl:px-2 2xl:px-0 flex items-center justify-between">
      <img src={bestlogo} alt="" className="w-[120px] md:w-[150px] xl:w-[200px]" />
      <div className="lg:flex items-center gap-6">
        <div className="hidden lg:flex items-center gap-10 font-bold text-[13px] xl:text-[16px] mr-14">
          <a href="">BOSH SAHIFA</a>
          <a href="">BIZ HAQIMIZDA</a>
          <div className="dropdown">
            <button className="dropbtn font-bold text-[13px] xl:text-[16px]">XIZMATLAR</button>
        ...
        <div className="flex items-center gap-6">
          <div>
            <div className="flex gap-3 items-center font-[700]">
              ...
              <h1 className="text-[14px] lg:text-[18px] 2xl:text-[20px]">+998999098015</h1>
            </div>
            <div className="flex gap-3 items-center text-[18px] font-[700] mt-3">
              ...
              <a href="https://t.me/best_buxgalter" className='text-[14px] lg:text-[18px] 2xl:text-[20px]'>@best_buxgalter</a>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-2 font-[700]">
              <img src={uzb} alt="" className="w-[15px] lg:w-[25px]" />
              <span className='text-[14px] lg:text-[18px] 2xl:text-[20px]'>UZB</span>
            </div>
            <div className="flex items-center gap-2 font-[700]">
              <img src={rus} alt="" className="w-[15px] lg:w-[25px]" />
              <span className='text-[14px] lg:text-[18px] 2xl:text-[20px]'>RUS</span>
            </div>
            <div className="flex items-center gap-2 font-[700]">
              <img src={eng} alt="" className="w-[15px] lg:w-[25px]" />
              <span className='text-[14px] lg:text-[18px] 2xl:text-[20px]'>ENG</span>
            </div>
          </div>
        </div>
      </div>
